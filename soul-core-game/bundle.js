// Soul Core Bundle - UMD, no imports, global Phaser
const Phaser = window.Phaser;
if (!Phaser) throw new Error('Phaser not loaded');
console.log('Bundling Soul Core, Phaser', Phaser.VERSION);
...
// --- soul-core-game/src/scenes/PreloadScene.js ---
...
// --- Main Game Config and Start ---
const GAME_CONFIG_BUNDLED = GAME_CONFIG;
...
window.addEventListener('load', () => {
    ...
    console.log('Soul Core Bundled - Game initialized');
    setTimeout(() => {
